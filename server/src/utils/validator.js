...
const newGroupChatValidator = () => [
  ...
  body("members")
    .notEmpty()
    .withMessage("Add members to the group!")
    .isArray({ min: 2, max: 100 })
    .withMessage("Add at least 2 members! and Max 100 members allowed!"),
];
const addMembersValidator = () => [
  body("members")
    ...
    .withMessage("Add at least 1 members!"),
...
const sendRequestValidator = () => [
  body(
    "ReceiverId",
    "ReceiverId for request not found in HTTP request!"
  ).notEmpty(),
];
const acceptRequestValidator = () => [
  body(
    "requestId",
    "requestId for request not found in HTTP request!"
  ).notEmpty(),
  body("status")
    .notEmpty()
    .withMessage("Status for request not found in HTTP request!")
    .isBoolean()
